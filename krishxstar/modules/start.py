    ...
    if chat_type == ChatType.PRIVATE:
        ...
        kb = InlineKeyboardMarkup([
            ...
            [
                ...
                InlineKeyboardButton("🍡 Source 🍡", url="https://github.com/KRISH-HACKER-OP/KrishXStarMusic"),
            ],
        ])
        ...
        # ── Broadcast DB save ─────────────────────────────────────────────────
        try:
            from KrishXStarMusic.database import add_broadcast_chat
