# ========================================================
# KRISH X STAR CODER - Config File
# ========================================================
...
# ======================================================
API_ID = int(getenv("API_ID", "31533046"))
API_HASH = getenv("API_HASH", "4f0f99c64d8e82a490c42a7faaa36710")
BOT_TOKEN = getenv("BOT_TOKEN", 8754634148:AAGSJXbkDIkMcwNiHO-EiMspmgUaemVBlXE)

# ======================================================
OWNER_ID = int(getenv("OWNER_ID", 7526566458))
OWNER_USERNAME = getenv("OWNER_USERNAME", "KRISH_HACKER_OWNER")
BOT_USERNAME = getenv("BOT_USERNAME", "KrishXStarBot")
BOT_NAME = getenv("BOT_NAME", "KRISH X STAR CODER")
...
# ======================================================
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/KrishXStar-DevZone")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# ======================================================
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/KRISH_HACKER_OP")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/KRISH_HACKER_OP")
